...
class AppColors {
  // Pearl School Branding Colors
  static const Color primary = Color(0xFF003E7E); // Deep Blue - school primary color
  ...
  static const Color navText = Color(0xFF003E7E); // Deep blue text for nav
  static const Color navBorder = Color(0xFFE5E7EB); // Light border

  // Button colors
  static const Color buttonPrimary = Color(0xFFDC143C); // Red - CTA buttons (from school logo)
  static const Color buttonSecondary = Color(0xFF003E7E); // Deep blue secondary button
  static const Color buttonOutline = Color(0xFF008B8B); // Teal outline button

  // Accent colors
  static const Color accent = Color(0xFF008B8B); // Teal accent (from building trim)
  static const Color accentHover = Color(0xFF006B6B); // Darker teal on hover
